package ntu_63130599.studentmanagement.Adapter;
...
import ntu_63130599.studentmanagement.ActivityStudent;
import ntu_63130599.studentmanagement.R;
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (checkBox.isChecked()){
                    ...
                    ActivityStudent.vitri.add(position);
                }
            }
        });
        return row;
