...
public class Cau3Fragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new LandScape("Cột cờ Hà Nội", "image1"));
        list.add(new LandScape("Tháp Eiffel", "image2"));
        list.add(new LandScape("Cung điện Buckingham", "image3"));
        list.add(new LandScape("Tượng nữ thần tự do", "image4"));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewLandScape=  viewCau3.findViewById(R.id.RecyclerCau3);
